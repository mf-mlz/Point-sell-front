            ...
            this.apiServiceClients.registerClients(formValue).subscribe({
                ...
                error: (error) => {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Ocurrió un error al Agregar el Cliente, verifica que el Correo y el Télefono no estén registrados en otro Cliente Activo',
                    });
                },
            });
        } else {
            ...
            this.apiServiceClients.editClients(formValue).subscribe({
                ...
                error: () => {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Ocurrió un error al Modificar el Cliente, verifica que el Correo y el Télefono no estén registrados en otro Cliente Activo',
                    });
                },
            });
        } else {
    ...
    deleteClient(credentials: DeleteRequest): void {
        this.apiServiceClients.deleteClients(credentials).subscribe({
            next: (response) => {
                Swal.fire({
                    icon: 'success',
                    title: response.message || 'Cliente Eliminado Correctamente',
                });
                this.getAllClients();
            },
            error: () => {
